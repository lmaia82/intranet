<?php
	class updateEvent{
		...
		function run(){
			...
			if($this->Event->updateEvents(addslashes($_POST["idUp"]),addslashes($_POST["local"]),addslashes($_POST["nome"]),addslashes($_POST["intro"]),$dt_inicio_formt,$dt_final_formt,addslashes($_POST["hinicio"]),addslashes($_POST["htermino"]))){
