<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Cadastro em Lote de Eventos Gravados</h2>
    </x-slot>
    <div class="py-6 max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded p-6 space-y-4">
            <p class="text-sm text-gray-600">
                Baixe o modelo de planilha CSV, preencha uma linha por evento gravado
            ...
            <a href="{{ route('eventos-gravados.lote.template') }}" class="inline-block px-4 py-2 bg-gray-200 rounded">Baixar modelo CSV</a>
            ...
            <form method="POST" action="{{ route('eventos-gravados.lote.import') }}" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div>
