...
<div id="kc-intranet-header" style="background:linear-gradient(to bottom,#B9DBF7,#ffffff);height:4rem;display:flex;align-items:center;justify-content:space-between;padding:0 1.5rem;box-shadow:0 1px 3px rgba(0,0,0,.1);">
...
<div id="kc-intranet-bluebar" style="width:100%;height:0.7cm;background:#166F9E;"></div>
